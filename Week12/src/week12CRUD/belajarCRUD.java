...
public class belajarCRUD {
    public static void main(String[] args) throws IOException{
        Scanner ntnt = new Scanner(System.in);
        String userChoise;
    ...
    private static void tampilkanData() throws IOException{
        ...
        while (data != null) {
            ...
            System.out.printf("|\t %4d  ", stringToken.nextToken());
    ...
    private static boolean getYesorNo (String messege){
        Scanner ntnt = new Scanner(System.in);
        System.out.println("\n" + messege + " (y/n) ?");
        String userChoise = ntnt.next();

        while (!userChoise.equalsIgnoreCase("y") &&  !userChoise.equalsIgnoreCase("n")){
            System.err.println("Pilihan anda bukan y atau n");
            System.out.println("\n" + messege + " (y/n) ?");
            userChoise = ntnt.next();
        }

        return userChoise.equalsIgnoreCase("y");
    }
